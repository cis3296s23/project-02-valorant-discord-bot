...
class rankCommand(commands.Cog):
    ...
    async def rank(self, ctx, region: str, riotName: str, riotId: str):
        ...
        if (radiantFlag == 1):
            ...
            embed = discord.Embed(title="Radiant", color=discord.Color.from_rgb(255, 255, 255), description= rrNum + "RR")
        ...
        if (rankName == "Iron"):
            ...
            embed = discord.Embed(title="Iron "+ rankNumber, color=discord.Color.dark_gray(), description= rrNum + "RR") #setting title, and color banner for embedding
        ...
        if (rankName == "Bronze"):
            ...
            embed = discord.Embed(title="Bronze "+ rankNumber, color=discord.Color.dark_gold(), description= rrNum + "RR")
        ...
        if (rankName == "Silver"):
            ...
            embed = discord.Embed(title="Silver "+ rankNumber, color=discord.Color.light_gray(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
        ...
        if (rankName == "Gold"):
            ...
            embed = discord.Embed(title="Gold "+ rankNumber, color=discord.Color.gold(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
        ...
        if (rankName == "Platinum"):
            ...
            embed = discord.Embed(title="Platinum "+ rankNumber, color=discord.Color.teal(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
        ...
        if (rankName == "Diamond"):
            ...
            embed = discord.Embed(title="Diamond "+ rankNumber, color=discord.Color.purple(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
        ...
        if (rankName == "Ascendant"):
            ...
            embed = discord.Embed(title="Ascendant "+ rankNumber, color=discord.Color.green(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
        ...
        if (rankName == "Immortal"):
            ...
            embed = discord.Embed(title="Immortal "+ rankNumber, color=discord.Color.red(), description= rrNum + "RR")
            embed.set_image(url ="attachment://" + disRankFile.filename)
            await ctx.send(file = disRankFile, embed = embed)
